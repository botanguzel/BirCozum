...
if ( !isset($uname, $fname, $lname, $passwrd, $email) ) {
	//data is not submitted
	exit('Lütfen bütün bilgieri doldurun!');
}
...
if ($stmt = $con->prepare('SELECT username FROM accounts WHERE username = ?')) {
    ...
    if ($stmt->num_rows > 0) {
      $err_msg = "Kullanıcı adı zaten kullanılıyor!";
      exit($err_msg);
    }
    else{
      if ($stmt = $con->prepare('SELECT username FROM accounts WHERE email = ?')) {
        ...
        $stmt->store_result();
        if ($stmt->num_rows > 0) {
          $err_msg = "Email adresi zaten kullanılıyor!";
          exit($err_msg);
        }
        else {
          $stm = $con->prepare('INSERT INTO accounts(username, firstName, lastName, password, email) VALUES (?, ?, ?, ?, ?)');
        $hashed_password = md5($passwrd);
        $stm->bind_param('sssss', $uname, $fname, $lname, $hashed_password, $email);
        $stm->execute();
        $res = $stm->get_result();
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'admin@xn--birczum-d1a.com';
            $mail->Password   = 'acotydmogvszioqp';
            $mail->SMTPSecure = 'tls';
            $mail->Port       = 587;

            // Set sender and recipient
            $mail->setFrom('admin@xn--birczum-d1a.comm', 'Admin');
            ...
            // Construct the HTML body for the mail to be sent
            ...
            * {
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="padding-right: 0px;padding-left: 0px;" align="center">
                  ...
                  <img align="center" border="0" src="images/image-3.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 208px;" width="208" class="v-src-width v-src-max-width"/>
            ...
            <table style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <h1 class="v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: \'Cabin\',sans-serif; font-size: 27px; font-weight: 400;">Welcome to Company Name</h1>
            ...
            <table style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div class="v-font-size" style="font-size: 14px; color: #ffffff; line-height: 160%; text-align: center; word-wrap: break-word;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="padding-right: 0px;padding-left: 0px;" align="center">
                  ...
                  <img align="center" border="0" src="images/image-4.gif" alt="Check" title="Check" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 24%;max-width: 127.2px;" width="127.2" class="v-src-width v-src-max-width"/>
            ...
            <div align="center">
              <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:42px; v-text-anchor:middle; width:266px;" arcsize="9.5%"  stroke="f" fillcolor="#3AAEE0"><w:anchorlock/><center style="color:#FFFFFF;font-family:\'Cabin\',sans-serif;"><![endif]-->  
                <a href="" target="_blank" class="v-button v-font-size" style="box-sizing: border-box;display: inline-block;font-family:\'Cabin\',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #3AAEE0; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                  <span class="v-padding" style="display:block;padding:13px 30px;line-height:120%;"><span style="font-size: 14px; line-height: 16.8px;">LOG IN TO YOUR NEW ACCOUNT</span></span>
                </a>
            ...
            <table style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <h1 class="v-font-size" style="margin: 0px; color: #21a70a; line-height: 140%; text-align: center; word-wrap: break-word; font-family: \'Cabin\',sans-serif; font-size: 24px; font-weight: 400;">Your New Account</h1>
            ...
            <table style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div class="v-font-size" style="font-size: 14px; color: #6e7172; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">Login : xxxxxx.xxxxxxx.company.com</span></p>
              </div>
            ...
            <table style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div class="v-font-size" style="font-size: 14px; color: #6e7172; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">Email : xxxxxx.xxxxxxx.@domain.com</span></p>
              </div>
            ...
            <table id="u_content_heading_3" style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <h1 class="v-font-size" style="margin: 0px; color: #21a70a; line-height: 140%; text-align: left; word-wrap: break-word; font-family: \'Cabin\',sans-serif; font-size: 24px; font-weight: 400;">We are here to help</h1>
            ...
            <table id="u_content_text_7" style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div class="v-font-size" style="font-size: 14px; color: #6e7172; line-height: 140%; text-align: left; word-wrap: break-word;">
            ...
            <table id="u_content_button_1" style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <!--[if mso]><style>.v-button {background: transparent !important;}</style><![endif]-->
            <div align="left">
              <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:42px; v-text-anchor:middle; width:204px;" arcsize="9.5%"  stroke="f" fillcolor="#3AAEE0"><w:anchorlock/><center style="color:#FFFFFF;font-family:\'Cabin\',sans-serif;"><![endif]-->  
                <a href="" target="_blank" class="v-button v-font-size" style="box-sizing: border-box;display: inline-block;font-family:\'Cabin\',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #3AAEE0; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                ...
                <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 20px">
                  <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    <a href="https://whatsapp.com/" title="WhatsApp" target="_blank">
                      <img src="images/image-5.png" alt="WhatsApp" title="WhatsApp" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                    </a>
                  </td></tr>
                </tbody></table>
                <!--[if (mso)|(IE)]></td><![endif]-->
            ...
            <table style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div class="v-font-size" style="font-size: 14px; color: #d1e122; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;">w w w . y o u r c o m p a n y . c o m</span></p>
              </div>
            ...
            <table style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div class="v-font-size" style="font-size: 14px; color: #888888; line-height: 180%; text-align: center; word-wrap: break-word;">
            ...
            <p style="font-size: 14px; line-height: 180%;"><span style="font-size: 12px; line-height: 21.6px;">&copy; 20XX Company. All Rights Reserved.</span></p>
              </div>
            ...
            exit('Failed to send email: ' . $mail->ErrorInfo);
        }
        }
      }
    }
