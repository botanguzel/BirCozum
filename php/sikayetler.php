                ...
                <div class="maindiv">
                  ...
                  <?php
                      if(isset($_SESSION['loggedin'])){
                        ...
                        <input id="title" name="entry_title" class="formtype" type="text" class="form-control-login" placeholder="Başlık" required pattern="^[a-zA-Z.! ]{2,80}"
                        title="Lütfen 2-40 karakter sınırlarına uyunuz">
                        <input id="desc" name="entry_desc" class="formtype" type="text" class="form-control-login" placeholder="Açıklama" required pattern="^[a-zA-Z.! ]{5,80}"
                        ...
                        <input id="mahalle" name="mahalle" class="formtype form-control-login" type="hidden" required>
          ...
          <div class="card">
            <div class="btn-group position-relative row" role="group">
              <div class="col-12 col-md-6 col-lg-auto mb-3">
                <button id="entries" class="entry_type btn shadow-sm mx-3 p-3 rounded btn-outline-secondary"><i class="bi bi-arrow-down"></i>Toplam şikayet sayısı</button>
                <button id="su-entry" class="entry_type btn shadow-sm mx-3 p-3 rounded btn-outline-secondary"><i class="bi bi-arrow-down"></i>Su şikayetleri</button>
                <button id="elektrik-entry" class="entry_type btn shadow-sm mx-3 p-3 rounded btn-outline-secondary"><i class="bi bi-arrow-down"></i>Elektrik şikayetleri</button>
                <button id="hayvan-entry" class="entry_type btn shadow-sm mx-3 p-3 rounded btn-outline-secondary"><i class="bi bi-arrow-down"></i>Hayvan şikayetleri</button>
                <button id="diger-entry" class="entry_type btn shadow-sm mx-3 p-3 rounded btn-outline-secondary"><i class="bi bi-arrow-down"></i>Diğer şikayetler</button>
              </div>
            </div>
          </div>
        </div>
